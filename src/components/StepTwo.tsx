		...
		<>
			<div className="w-3/5 absolute bottom-3 right-10 top-10 flex flex-col">
				...
				<div className="flex flex-row mt-10 justify-evenly items-center ">
					<div
						className="flex flex-row hover:cursor-pointer relative rounded-md w-36 h-40 border border-indigo-600"
						onClick={handleClick}
					>
						...
						<div className="absolute bottom-3 left-2 flex flex-col">
							<div className="font-semibold hover:cursor-pointer text-blue-600 text-lg text-center ml-2">
								Arcade
							</div>
					...
					>
						...
						<div className="absolute bottom-3 left-2 flex flex-col">
							<div className="font-semibold hover:cursor-pointer text-blue-600 text-lg ml-2">
								Pro
							</div>
